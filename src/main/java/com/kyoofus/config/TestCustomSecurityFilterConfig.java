...
import com.kyoofus.custom.CustomSecurityFilter;
import com.kyoofus.custom.CustomSecurityProvider;
...
public class TestCustomSecurityFilterConfig {
    ...
    @Autowired
    private CustomSecurityProvider customSecurityProvider;
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(customSecurityProvider);
